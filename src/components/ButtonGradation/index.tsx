...
const ButtonGradation = ({ children, onClick }: Props) => {
  return (
    ...
    >
      <span className='flex items-center whitespace-nowrap relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-full group-hover:bg-opacity-0'>
        {children}
      </span>
    </button>
  );
